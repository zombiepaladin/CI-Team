...
static function ApplyHeightmap (HDRpath) {
 
	var cellSize : float = 30;//adjust this according to the resolution of the file you are using.
    ...
    EditorUtility.DisplayDialog("path", hdrpath + " ... " + filepath, "OK");
